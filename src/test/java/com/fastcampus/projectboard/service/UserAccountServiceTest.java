...
class UserAccountServiceTest {
    ...
    @DisplayName("존재하는 회원 ID를 검색하면, 비어있는 Optional을 반환한다")
    @Test
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("userPassword", userAccount.getUserPassword())                .hasFieldOrPropertyWithValue("email", userAccount.getEmail())
