...
class ArticleWithCommentsResponseTest {
    ...
    void givenArticleWithCommentsDto_whenMapping_thenOrganizesParentAndChildCommentsWithCertainOrders() {
        ...
        assertThat(actual.articleCommentsResponses())
                ...
                .flatExtracting(ArticleCommentResponse::childComments) // 자식 댓글만 쭉 펼처서 추출하기 위해 사용 flatExtracting
                .containsExactly(
    ...
    private ArticleCommentDto createArticleCommentDto(Long id, Long parentCommentId, LocalDateTime createAt) {
    ...
    private ArticleCommentResponse createArticleCommentResponse(Long id, Long parentCommentId, LocalDateTime createAt) {
